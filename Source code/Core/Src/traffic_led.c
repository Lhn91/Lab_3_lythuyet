...
void traffic_green_red(){
 ...
 HAL_GPIO_WritePin(G1_GPIO_Port, G1_Pin, RESET); //ON
 HAL_GPIO_WritePin(Y1_GPIO_Port, Y1_Pin, SET);

 HAL_GPIO_WritePin(R_GPIO_Port, R_Pin, RESET); //ON
...
void traffic_amber_red(){
	HAL_GPIO_WritePin(R1_GPIO_Port, R1_Pin, SET);
	 ...
	 HAL_GPIO_WritePin(Y1_GPIO_Port, Y1_Pin, RESET); //ON
...
void traffic_red_green(){
	HAL_GPIO_WritePin(R1_GPIO_Port, R1_Pin, RESET); //ON
	 HAL_GPIO_WritePin(G1_GPIO_Port, G1_Pin, SET);
	 HAL_GPIO_WritePin(Y1_GPIO_Port, Y1_Pin, SET);

	 HAL_GPIO_WritePin(R_GPIO_Port, R_Pin, SET);
	 HAL_GPIO_WritePin(G_GPIO_Port, G_Pin, RESET); //ON
	 HAL_GPIO_WritePin(Y_GPIO_Port, Y_Pin, SET);
